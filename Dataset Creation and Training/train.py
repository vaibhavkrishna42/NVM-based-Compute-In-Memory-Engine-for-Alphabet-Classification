...
X_val, y_val = torch.load("validation_data_60.pt", weights_only=True)
...
# Train the model
train_losses, val_losses = train_model(model, train_loader, val_loader, num_epochs=700)
...
# torch.save(model.state_dict(), "neuro_model.pth")